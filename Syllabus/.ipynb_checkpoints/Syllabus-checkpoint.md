...
| Week 1 | - Text processing on the Linux/Mac Terminal <br /> - Introduction to GitHub <br /> - File management on the Linux/Mac Terminal| - Create your GitHub Account: [GitHub](https://github.com/) <br /> - Clone the class repository: [NLP4Spanish](https://github.com/falconrr/NLP4SPanish) <br /> - Lab assignment 1|
